...
fig.gca().annotate("GPI H band, {0:,} iterations (192 walkers): {1:,} models".format(reader.iteration, reader.iteration*192),
...
fig.suptitle('GPI H band: Best Model and Residuals', fontsize=5/4.*caracsize, y = 0.985)

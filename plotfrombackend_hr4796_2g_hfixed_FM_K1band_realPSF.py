...
if socket.gethostname()== 'MT-101942':
    datadir='/Users/jmazoyer/Dropbox/ExchangeFolder/data_python/Aurora/150403_K1_Spec/'
else:
    datadir='/home/jmazoyer/data_python/Aurora/150403_K1_Spec/'


file_prefix = 'K1band_hr4796_klipFM_MaxiNoise'
...
print(np.min(log_prob_samples_flat))
...
fig.gca().annotate("GPI K1 band, {0:,} iterations (192 walkers): {1:,} models".format(reader.iteration, reader.iteration*192),
...
# excluded_files = check_gpi_satspots(datadir, removed_slices= removed_slices, SavePSF=False, SaveAll=False)
...
fig.suptitle('GPI K1 band: Best Model and Residuals', fontsize=5/4.*caracsize, y = 0.995)

...
file_prefix = 'Hband_hd48524_klipFM_injecteddisk'
...
name_h5 = 'Hband_hd48524_klipFM_injecteddiskbackend_file_mcmc'
...
fig=corner.corner(samples, labels=labels, 
	quantiles=(0.001, 0.159, 0.5, 0.841, 0.999),show_titles=True, plot_datapoints=True, verbose=False)#, levels=(1-np.exp(-0.5),))

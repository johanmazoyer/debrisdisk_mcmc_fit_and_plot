...
########################################################
########################################################
#### Fonctions extraite de anadisk From Max do not dessinate
########################################################
########################################################
...
if first_time == 1:
    ...
    theta_here = (np.log(74.3),np.log(99.9),12, 0.78, -0.21, 0.31, np.cos(np.radians(76.79)), 26.73, -1.7,0.85, np.log(189))

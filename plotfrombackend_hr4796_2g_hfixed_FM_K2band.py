...
if socket.gethostname()== 'MT-101942':
    datadir='/Users/jmazoyer/Dropbox/ExchangeFolder/data_python/Aurora/150403_K2_Spec/'
else:
    datadir='/home/jmazoyer/data_python/Aurora/150403_K2_Spec/'


file_prefix = 'K2band_hr4796_klipFM_MaxiNoise'
...
fig.gca().annotate("GPI K2 band, {0:,} iterations (192 walkers): {1:,} models".format(reader.iteration, reader.iteration*192),
...
removed_slices = np.arange(18)+19
# removed_slices = None
...
fig.suptitle('GPI K2 band: Best Model and Residuals', fontsize=5/4.*caracsize, y = 0.985)

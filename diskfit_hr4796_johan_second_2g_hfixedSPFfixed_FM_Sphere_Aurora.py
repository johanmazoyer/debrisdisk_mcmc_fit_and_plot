...
file_prefix = 'Sphere_hr4796_klipFM_cent'
...
if first_time == 1:
    ...
    theta_here = (np.log(74.250817),np.log(99.99989),13.577284, 0.934624, -0.1589003,  0.3997630952, np.cos(np.radians(76.761931)),26.880600, -2.214981, 2.1155435, np.log(138.38116))  
...
filename_backend = mcmcresultdir + file_prefix+"backend_file_mcmc_newprior.h5"
...
if __name__ == '__main__':
    ...
    # with contextlib.closing(MPIPool()) as pool:
        ...
        if new_backend ==1:
            ...
            w10= np.random.uniform( theta_here[10]*0.999 ,   theta_here[10]*1.001  ,   size=(nwalkers))    #log normalizing factor
